...
const CvPreviewTemplateOne = ({ className }: CvPreviewTemplateOneProps) => {
  ...
  return (
    <div className={cn('w-full px-4', className)}>
      <Card className="flex aspect-[877/620] w-full max-w-screen-md flex-col gap-5 border p-5 font-[family-name:var(--font-times-new-roman)] text-xs md:text-sm lg:h-[calc(100svh-96px)] lg:overflow-y-auto">
        {header?.content && (
