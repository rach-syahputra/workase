      ...
      <div className="flex justify-center w-full">
        <div className="w-[420px]">
          <div className="flex flex-col justify-center">
            <div className="flex items-center justify-center gap-3 pb-3 text-center text-[24px] font-medium">
              {' '}
              <IoPerson className="w-4 scale-125" />
              Reset Password Form
            </div>
            <div className="flex justify-center text-center md:pt-[10px]">
              Enter Your New Personal Account Password to Continue, After That
