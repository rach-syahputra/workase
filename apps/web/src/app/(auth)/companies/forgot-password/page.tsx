      ...
      <div className="flex w-full justify-center">
        <div className="w-[420px]">
          <div className="flex flex-col justify-center p-1 pb-2">
            <div className="flex items-center justify-center gap-3 p-3 text-center text-[23.1px] font-medium">
              {' '}
              <Building2 className="w-4 scale-125" />
              Forgot Password Form
            </div>
            <div className="flex justify-center text-center text-[16px] md:pt-[10px]">
              Enter Your Company Email Address and We`ll Send You a Link to
              Reset Your Password
            </div>
